...
Author: Matus Tomko, 2021
Synaptic plasticity: Jedlicka et al., 2015
NMDA properties: Mark Cembrowski, 2012

This is an extension of the Exp2Syn class to intercorporate NMDA-like properties from Elena Saftenku (2001) and
and a form of stream-specific spike-timing-dependent plasticity (STDP) from Jedlicka et al. (2015).
...
NEURON {
	POINT_PROCESS Exp2Syn_NMDA_metaSTDP
	USEION ca READ eca WRITE ica
	RANGE tau1, tau2, e, i, dtau, ptau, ica, mgBlock, theDrive, theEca, wMax
